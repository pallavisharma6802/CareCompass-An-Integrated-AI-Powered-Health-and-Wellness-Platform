...
def main():
    st.title("Meal-Maker: Custom Food Recommendation")
    ...
    n_neighbors = st.sidebar.slider('Number of recommendations', 2, 20,step=2)
            ...
            if recommendations:
                for recipe in recommendations:
                    ...
                    with expander:
                        ...
                        expander.markdown(f'<h6 style="text-align: center;font-family:sans-serif;">Ingredients:</h6>', unsafe_allow_html=True)
                        for ingredient in recipe['RecipeIngredientParts']:
                            st.markdown(f"- {ingredient}")
                        expander.markdown(f'<h6 style="text-align: center;font-family:sans-serif;">Recipe Instructions:</h6>', unsafe_allow_html=True)    
