...
def peacepal_app():
    ...
    st.header("‍⚕️ PeacePal - Journeying Towards Inner Peace.")
    st.subheader("Chatting your way to a peaceful mind.")
    ...
    user_prompt = st.chat_input("Ask PeacePal...")
    if user_prompt:
